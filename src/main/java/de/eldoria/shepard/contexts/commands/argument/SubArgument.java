 ...
 * A sub argument is a command arg, but is depending on the {@link CommandArgument} command.
...
public class SubArgument {
     ...
     */
    public SubArgument(String argumentName, String localeTag) {
     ...
     */
    public SubArgument(String argumentName, String localeTag, boolean isSubCommand) {
        this.argumentName = argumentName;
        this.localeTag = localeTag;
